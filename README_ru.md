...
- Хост. Любая ЭВМ, оснащённая USB-портом в режиме host-mode. Практически любой современный смартфон удовлетворяет этому требованию.
- Сеть. Образуется Устройствами при помощи ПО на Хосте. Данное ПО включает в себя облегчённый стек сетевых протолов, который отчасти копирует TCP/IP и приспособлен для потребностей проекта.
...
![net_packet_ru](./device/docs/net_packet_ru.png)
...
![classes_diagram](./device/docs/classes_diagram.png)
...
![smart_routing_ru](./device/docs/smart_routing_ru.png)
