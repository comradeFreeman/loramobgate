...
void setup() {
  ...
  int8_t nssPin = 10, resetPin = 9, irqPin = 3, txenPin = 8, rxenPin = 7;
  ...
  Serial.println("Set frequency to 434 Mhz");
  ...
  LoRa.setSpreadingFactor(9);                                       // LoRa spreading factor: 7
  LoRa.setBandwidth(125000);                                        // Bandwidth: 125 kHz
  LoRa.setCodeRate(7);                                              // Coding rate: 4/5
  ...
  LoRa.setPreambleLength(8);                                       // Set preamble length to 12
